...
def play_middRout_games_sp(tm_id, env_middRout_sp, agent, best=None):
    ...
    while 1:
        ...
        reward, done, error_eval_links, demand, source, destination, maxLinkUti, minLinkUti, utiStd = env_middRout_sp.step(
